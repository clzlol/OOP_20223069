...
public class StudentScoresTester {
	public static void main(String[] args) {
		...
		/** And here */
		Student high = studSc.getHighest();
		Student low = studSc.getLowest();
		System.out.println("The highest student and score: " + high.name() + " " + high.score());
		System.out.println("The lowest student and score: " + low.name() + " " + low.score());
	}
}
